...
def test_create_and_move_module() -> None:
    ...
    client.post("/api/v1/admin/cms/modules",
        json={"module_type": "product_recommend", "title": "P", "data_source_url": "/api/v1/web/products?status=active", "sort_order": 2, "is_enabled": False},
        headers=headers)
