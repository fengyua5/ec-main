...
describe("HomeModuleRenderer", () => {
  it("renders banner module", () => {
    const modules: HomeModule[] = [
      { id: 1, module_type: "banner", title: "轮播", description: "", data_source_url: "", is_static: false, sort_order: 1 },
    ];
  ...
  it("renders product grid module", () => {
    const modules: HomeModule[] = [
      { id: 2, module_type: "product_recommend", title: "商品推荐", description: "", data_source_url: "", is_static: false, sort_order: 1 },
    ];
    render(<HomeModuleRenderer modules={modules} data={data} />);
  ...
  it("renders announcement module", () => {
    const modules: HomeModule[] = [
      { id: 3, module_type: "announcement", title: "公告", description: "", data_source_url: "", is_static: false, sort_order: 1 },
    ];
    render(<HomeModuleRenderer modules={modules} data={data} />);
    expect(screen.getByText("公告1")).toBeInTheDocument();
  });

  it("renders search bar module", () => {
    const modules: HomeModule[] = [
